 ...
 */
@Configuration
@DependsOn(CommonConstant.SPRING_UTILS)
public class ShiroConfig {
     ...
     * @author Rong.Jia
     * @date 2019/04/17 10:18:22
     * @return ShiroFilterFactoryBean shiro 拦截对象
     */
    @Bean("shiroFilter")
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
        ...
        // 添加自己的过滤器取名为jwt
        Map<String, Filter> filterMap = new HashMap<>(NumberConstant.SIXTEEN);
        ...
        LinkedHashMap<String, String> filterChainDefinitionMap = new LinkedHashMap<String, String>(NumberConstant.SIXTEEN);
